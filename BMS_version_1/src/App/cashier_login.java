...
static ImageIcon ii;
    ...
    private void initComponents() {
        ...
        btn_forgotpassword.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btn_forgotpasswordMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
...
int xy,xx;
    ...
    private void btn_signupMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_signupMouseEntered
        btn_signup.setForeground(new Color(255,102,0));
    ...
    private void btn_signupMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_signupMouseExited
        btn_signup.setForeground(new Color(153,153,153));
    ...
    private void btn_signinMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_signinMouseClicked
        String sql = "select username,password from cashieracc where username=?and password=?";
        if (txt_username.getText().length() == 0) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    this.dispose();
                    cashier_home L = new cashier_home();
                    L.setVisible(true);
                } else {
    ...
    private void btn_signupMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_signupMouseClicked
        dispose();
        cashier_sign_up c = new cashier_sign_up();
        c.setVisible(true);
    }//GEN-LAST:event_btn_signupMouseClicked

    private void btn_forgotpasswordMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_forgotpasswordMouseClicked
        
    }//GEN-LAST:event_btn_forgotpasswordMouseClicked
