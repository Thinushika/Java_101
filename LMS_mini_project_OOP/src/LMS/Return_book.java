...
public void returnUpdate(){
        String sql = "Insert into bookreturn(studentid,name,regno,course,year,semester,bookid,title,author,isbn,publisher,category,price,dateofissue,dateofreturn)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
try{
         pst=conn.prepareStatement(sql);
            ...
            pst.setString(9,txt_author.getText());
             pst.setString(10,txt_isbn.getText());
            pst.setString(11,txt_publisher.getText());
            pst.setString(12,txt_category.getText());
            pst.setString(13,txt_price.getText());
            pst.setString(14,txt_issuedate.getText());
            pst.setString(15,txt_returndate.getText());
               pst.execute();
                 rs.close();
            pst.close();
}catch(Exception ex){
    ...
    private void initComponents() {
        ...
        jLabel6.setText("To LMS");
        jPanel4.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 70, 130, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(102, 102, 102));
        jLabel4.setText("Return Book");
        jPanel4.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 20, -1, -1));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LMS/images/return book.png"))); // NOI18N
        ...
        jPanel1.add(txt_memberid, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 240, 250, 30));
        ...
        jPanel1.add(searchMid_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 240, -1, 30));
        ...
        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LMS/images/icons8_Return_Book_24px_1.png"))); // NOI18N
        ...
        jPanel1.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 510, 290, 40));
        ...
        jPanel1.add(error2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 270, 240, -1));
        ...
        jLabel17.setText("LMS Return Book");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txt_title, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_author, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_publisher, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_category, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 240, 410, 250));
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txt_Regno, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_course, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Year, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txt_semester, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        jPanel1.add(jPanel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(78, 303, 420, -1));

        jLabel22.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel22.setForeground(new java.awt.Color(102, 102, 102));
        jLabel22.setText("Date of Issue :");
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 480, -1, -1));
        ...
        jPanel1.add(txt_issuedate, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 270, 290, 20));

        txt_returndate.setEditable(false);
        txt_returndate.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        txt_returndate.setForeground(new java.awt.Color(102, 102, 102));
        txt_returndate.setBorder(null);
        txt_returndate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_returndateActionPerformed(evt);
            }
        });
        jPanel1.add(txt_returndate, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 520, 290, 20));

        jLabel34.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel34.setForeground(new java.awt.Color(102, 102, 102));
        jLabel34.setText("Date of Return :");
        jPanel1.add(jLabel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 520, -1, -1));
 ...
 int xy,xx;
    ...
    private void searchMid_btnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchMid_btnMouseClicked
        ...
        try{
            ...
            rs=pst.executeQuery();
            if (rs.next()){
                txt_bookid.setText(rs.getString(7));
                ...
                txt_title.setText(rs.getString(8));
                txt_author.setText(rs.getString(9));
                txt_publisher.setText(rs.getString(10));
                txt_category.setText(rs.getString(11));
                txt_isbn.setText(rs.getString(12));
                txt_price.setText(rs.getString(13));
                txt_issuedate.setText(rs.getString(14));
                error2.setVisible(false);
                rs.close();
                pst.close();
            }
